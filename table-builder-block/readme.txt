...
= Is TableKit responsive for all screens? =
...
* Added: Elementor widget support to use tables directly inside Elementor.
* Added: Row grouping feature for better table organization.
* Improved: Shortcode system for better flexibility and performance.

= TableKit 2.2.5 (2026-05-04) =
* Added: Shortcode support for displaying tables anywhere on your site.
* Improved: Template Library interface for a smoother user experience.

= TableKit 2.2.4 (2026-04-20) =
* Fixed: Changelog display issue.
* Improved: Template Library design and usability.
* Improved: Dashboard interface for a cleaner and more user-friendly experience.
...
* Improved: Pagination controls and behavior
* Improved: Freeze table functionality
* Fixed: Free & Pro license check issue
* Fixed: Block validation error by adding proper deprecation handling
* Fixed: Editor jump issue during table interactions
* Removed: Unnecessary markup from both editor and frontend output
* Added: Keyboard shortcut support for merge actions
* Added: Merge modal synchronization with list view
* Added: Caption position control with show/hide option
* Added: Pattern support with required plugin check
...
* Fixed: Site panel conditional visibility
