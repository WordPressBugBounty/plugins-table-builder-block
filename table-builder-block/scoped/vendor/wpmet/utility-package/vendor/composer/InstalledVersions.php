 ...
 */
namespace TableBuilderScopedDeps\Composer;

use TableBuilderScopedDeps\Composer\Autoload\ClassLoader;
use TableBuilderScopedDeps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('TableBuilderScopedDeps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
