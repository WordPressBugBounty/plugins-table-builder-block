...
class Utils {
	...
	public static function add_class_to_svg( $svg ) {
		$originalString = $svg;
		$substringToAdd = "class='table-builder-icon' ";
	 ...
	 * Finally, it applies the "roxslider/dynamic_block_wrapper_attributes" filter and returns the wrapper attributes.
	 *
	 ...
	 * get box value
	 * 
	 * Similar to getBoxValue in roxslider js helper
	 * @param array $key
	 ...
	 * 
	 * Similar to fillBackgroundGenerator in roxSlider js helper
	 * 
	 ...
	 * 
	 * Similar to getTypographyValue in roxSlider js helper
	 */
	...
	/**
	 * Check if the block is a roxSlider block.
	 * 
	 * @param string $attrs
	 * @return bool
	 */
	public static function is_table_builder_block($block_content, $parsed_block, $attrs = '', $attrs2 = '') {
		...
		$hasValidBlockName = isset($parsed_block['blockName']) && strpos($parsed_block['blockName'], 'tablebuilder') !== false;
